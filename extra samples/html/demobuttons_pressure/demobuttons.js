...
function print(txt, bforceDisplay) {
  if (m_Debug == 1 || bforceDisplay == true)
  {
  ...
  this.connect = function () {
    ...
    if (usbDevices.Count > 0) {
      ...
      if (ec.value == 0) {
		...
		//m_inkThreshold.onPressureMark = 250;
		//m_inkThreshold.offPressureMark = 220;
      ...
      clearScreen();
      print("On pressure: " + m_inkThreshold.onPressureMark, true);
	  print("Off pressure: " + m_inkThreshold.offPressureMark, true);
      try
      {
  ...
  function onPenData(penData) { // Process incoming pen data
    ...
    else
    {
      ...
      if (m_isDown == -1) 
      {
		...
		if (penData.pressure >= m_inkThreshold.onPressureMark && m_lastPressure >= m_inkThreshold.onPressureMark)
		{
		   //print("On pressure: " + m_inkThreshold.onPressureMark, true);
		   print("Last and current " + m_lastPressure + ", " + penData.pressure, true);
		   //print (" ", true);
	...
	m_lastPressure = penData.pressure;
  }

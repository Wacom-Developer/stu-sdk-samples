...
function SignatureForm(preview) {
  ...
  this.connect = function () {
    ...
    if (usbDevices.Count > 0) {
	  ...
	  var rect = new ActiveXObject("WacomGSS.STU.IRectangle");
      rect.upperLeftXPixel  = 10;
	  rect.upperLeftYPixel  = 10;
      
	  rect.lowerRightXPixel = 50;
      rect.lowerRightYPixel = 50;
	  
	  print("Setting handwriting area");
      m_tablet.setHandwritingDisplayArea(rect); 
	  print("Area set");
    } else {

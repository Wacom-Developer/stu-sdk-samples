/******************************************************* 
  ...
  Handwriting area is restricted to a rectangular area
  on the pad
...
namespace DemoButtons
{
	public partial class DemoButtonsForm : Form
	{
		...
		private void btnSign_Click(object sender, EventArgs e)
		{
			...
			if (usbDevices.Count != 0)
			{
				try
				{
					...
					SignatureForm demo = new SignatureForm(this, usbDevice, chkUseEncryption.Checked);
		...
		private void DisplaySignature(SignatureForm demo )
		{
			...
			bitmap = Rendering.GetSigImage(demo);

...
Public Class SignatureForm
   ...
   ' SignatureForm
   Public Sub New(ByVal ParentForm As DemoButtonsForm, ByVal usbDevice As wgssSTU.IUsbDevice, ByVal serialInterface As wgssSTU.SerialInterface, ByVal COMPort As String, ByVal baudRate As String, ByVal HIDMode As Boolean)
      m_ParentForm = ParentForm
      Dim ec As wgssSTU.IErrorCode
      ...
      Dim protocolHelper As New wgssSTU.ProtocolHelper
      m_tablet = New wgssSTU.Tablet

      If (HIDMode) Then
         ec = m_tablet.usbConnect(usbDevice, True)
      Else
         Dim padBaudRate As UInt32 = UInt32.Parse(baudRate)
         ec = m_tablet.serialConnect(COMPort, padBaudRate, True)
      End If
      ...
      Dim productId As UShort = m_tablet.getProductId()

      If (productId <> &HA2) Then
